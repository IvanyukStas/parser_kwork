...
if __name__ == "__main__":
    ...
    time.sleep(8)
    try:
        login_js = driver.find_element(
            by=By.XPATH,
            value='//*[@id="body"]/div[4]/div[2]/div[1]/div/div[2]/div[4]/ul/li[1]/a',
        ).click()
        time.sleep(1)
    except:
        print("tiri piri")
        ...
        username = driver.find_element(
            by=By.XPATH, value='//*[@id="form-login"]/div[1]/div[3]/div[2]/input'
        )
        username.send_keys("aswd25@yandex.ru")
        password = driver.find_element(
            by=By.XPATH, value='//*[@id="form-login"]/div[1]/div[3]/div[3]/div[1]/input'
        )
        password.send_keys("a1234567")
        login_button = driver.find_element(
            by=By.XPATH, value='//*[@id="form-login"]/div[1]/div[3]/button[1]'
        ).click()
        time.sleep(5)
    driver.get(base_url)
